...
const ArkivPage = () => {
  ...
  const handleNavigate14 = () => navigate("/valdbild");
    ...
    <>
      <Column className="bg-gray-100 font-roboto mx-[auto] w-[100%]">
        <Column className="items-start justify-start lg:mb-[15px] xl:mb-[17px] mb-[20px] 3xl:mb-[24px] w-[100%]">
          ...
          <Text className="font-medium lg:mt-[15px] xl:mt-[17px] mt-[20px] 3xl:mt-[24px] lg:mx-[129px] xl:mx-[147px] mx-[166px] 3xl:mx-[199px] text-black_900 lg:text-fs28 xl:text-fs32 text-fs36 3xl:text-fs43 text-left">{`Lista med alla bilder`}</Text>
          <Column className="w-[100%]">
